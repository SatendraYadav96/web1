...
const BuHeadDashboardComponents = ({authInfo,profileInfo}) => {
...
BuHeadDashboardComponents.propTypes = {
...
export default connect(mapState, actions) (BuHeadDashboardComponents)
