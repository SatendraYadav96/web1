    ...
    const searchData = () => {
        ...
        setColumn([
            ...
            },
            {
                ...
                width: '100px',
                ...getColumnSearchProps('receivedatHub'),
            },
            {
                ...
                width: '100px',
                ...getColumnSearchProps('dispatched'),
            },
            {
                ...
                width: '100px',
                ...getColumnSearchProps('hub_Balance'),
            },
            {
                ...
                dataIndex: 'destroyed',
                width: '100px',
                ...getColumnSearchProps('destroyed'),
            },
            {
                ...
                dataIndex: 'validated',
                width: '100px',
                ...getColumnSearchProps('validated'),
            },
            {
                ...
                width: '100px',
                ...getColumnSearchProps('pending_Validation'),
            },
            {
                ...
                width: '100px',
                ...getColumnSearchProps('distribute'),
            },
            {
                title: 'FF Balance',
                key: 'balance',
