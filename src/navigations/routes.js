...
const routes = [
    ...
    { path: '/home/buheaddashboard', name: 'BuHeadDashboardComponent', element: BuHeadDashboardComponent },
    { path: '/home/rbmdashboard', name: 'RBMDashboardComponent', element: RbmDashboardComponent },
