import {
    ...
    MULTIPLE_ALLOCATION_UPLOAD_SUCCESS,
    ...
    SPECIAL_DIFFERENTIAL_TEAM_START,
    ...
    MULTIPLE_ALLOCATION_UPLOAD_MONTHLY_START,
    MULTIPLE_ALLOCATION_UPLOAD_MONTHLY_SUCCESS,
    MULTIPLE_ALLOCATION_UPLOAD_MONTHLY_FAIL,
    MULTIPLE_ALLOCATION_UPLOAD_VIRTUAL_START,
    MULTIPLE_ALLOCATION_UPLOAD_VIRTUAL_SUCCESS,
...
export const multipleAllocationUploadSpecialStartAction = (payload) => (dispatch) => {
    dispatch({
        type: MULTIPLE_ALLOCATION_UPLOAD_SPECIAL_START,
        payload: payload
    })
}

export const multipleAllocationUploadSpecialSuccessAction = (payload) => (dispatch) => {
    dispatch({
        type: MULTIPLE_ALLOCATION_UPLOAD_SPECIAL_SUCCESS,
        payload: payload
    })
}

export const multipleAllocationUploadSpecialFailAction = (payload) => (dispatch) => {
    dispatch({
        type: MULTIPLE_ALLOCATION_UPLOAD_SPECIAL_FAIL,
        payload: payload
    })
}


export const multipleAllocationUploadMonthlyStartAction = (payload) => (dispatch) => {
    dispatch({
        type: MULTIPLE_ALLOCATION_UPLOAD_MONTHLY_START,
        payload: payload
    })
}

export const multipleAllocationUploadMonthlySuccessAction = (payload) => (dispatch) => {
    dispatch({
        type: MULTIPLE_ALLOCATION_UPLOAD_MONTHLY_SUCCESS,
        payload: payload
    })
}

export const multipleAllocationUploadMonthlyFailAction = (payload) => (dispatch) => {
    dispatch({
        type: MULTIPLE_ALLOCATION_UPLOAD_MONTHLY_FAIL,
        payload: payload
    })
}
...
export const multipleAllocationUploadVirtualStartAction = (payload) => (dispatch) => {
    dispatch({
        type: MULTIPLE_ALLOCATION_UPLOAD_VIRTUAL_START,
        payload: payload
    })
}

export const multipleAllocationUploadVirtualSuccessAction = (payload) => (dispatch) => {
    dispatch({
        type: MULTIPLE_ALLOCATION_UPLOAD_VIRTUAL_SUCCESS,
        payload: payload
    })
}

export const multipleAllocationUploadVirtualFailAction = (payload) => (dispatch) => {
    dispatch({
        type: MULTIPLE_ALLOCATION_UPLOAD_VIRTUAL_FAIL,
        payload: payload
    })
}
